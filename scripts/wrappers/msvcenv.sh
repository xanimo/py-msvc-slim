...
export SDK=kits\\10
export SDK_UNIX=kits/10
export BASE_UNIX=$(cd "$(dirname "${BASH_SOURCE[0]}")"/.. && pwd)
...
export BASE=z:${BASE_UNIX//\//\\}
export MSVCVER=14.33.31629
export SDKVER=10.0.19041.0
export ARCH=x86
export MSVCDIR="$BASE\\vc\\tools\\msvc\\$MSVCVER"
export SDKINCLUDE="$BASE\\$SDK\\include\\$SDKVER"
export SDKLIB="$BASE\\$SDK\\lib\\$SDKVER"
export BINDIR=$BASE_UNIX/vc/tools/msvc/$MSVCVER/bin/Hostx64/$ARCH
export SDKBINDIR=$BASE_UNIX/$SDK_UNIX/bin/$SDKVER/x64
